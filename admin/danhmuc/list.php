...
<div class="row">
    ...
    <div class="row frmcontent">
        <form action="index.php?act=delete_selected_dm" method="post">
            <div class="row mb10 frmdsloai">
                <table border="0" style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                    <thead>
                        <tr style="background-color: #fff9e6; height: 40px;">
                            <th style="width: 50px; text-align: center;"></th>
                            <th style="width: 50px; text-align: center;">STT</th>
                            <th style="width: 100px; text-align: center;">Mã loại</th>
                            ...
                            foreach ($listdm as $dm) {
                                ...
                                echo '<tr style="height: 50px;">
                                        <td style="text-align: center;">
                                            <input type="checkbox" name="name_id[]" value="' . $iddm . '">
                                        </td>
                                        <td style="text-align: center;">' . $stt . '</td>
                                        <td style="text-align: center;">' . $iddm . '</td>
                                        <td style="padding-left: 15px; text-align: center;">' . $tendm . '</td>
                                        <td style="text-align: center;">
                                            <a href="' . $suadm . '"><input type="button" value="Sửa" style="cursor:pointer; padding: 5px 10px;"></a>
                                            <a href="' . $xoadm . '" onclick="return confirm(\'Bạn có chắc muốn xóa?\')">
                                                <input type="button" value="Xóa" style="cursor:pointer; padding: 5px 10px; background-color: #ff4d4d; color: white; border: none; border-radius: 3px;">
                                            </a>
                                        </td>
                                      </tr>';
                                $stt++;
            ...
            <div class="row mb10" style="margin-top: 20px; display: flex; gap: 10px;">
                <input type="button" value="Chọn tất cả" id="check-all" style="padding: 10px; cursor: pointer;">
                <input type="button" value="Bỏ chọn tất cả" id="uncheck-all" style="padding: 10px; cursor: pointer;">
                <input type="submit" name="delete_selected" value="Xóa các mục đã chọn"
                    ...
                    onclick="return confirm('Bạn có chắc chắn muốn xóa các mục đã chọn?')">
...
<script>
    ...
    const checkboxes = document.querySelectorAll('input[name="name_id[]"]');
